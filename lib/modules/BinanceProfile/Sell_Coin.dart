...
import 'package:CanuckCrypto/modules/buysell/SellCoin.dart';
import 'package:flutter/material.dart';

class Sell_Coin extends StatefulWidget {
  @override
  _Sell_CoinState createState() => _Sell_CoinState();
}

class _Sell_CoinState extends State<Sell_Coin> {
  @override
                ...
                Container(
                  ...
                  child:Padding(
                    ...
                    children: [
                      ...
                      SizedBox(height: 40,),
                      Text('Sell USDT' , style: TextStyle(fontSize: 18 , fontWeight: FontWeight.w600 ,),),
                      SizedBox(height: 15),
                      Row(
                        children: [
